<div>
    <form wire:submit.prevent="store">
        @csrf
        <div class="mb-3">
            <label class="form-label">* {{__('messages.AnnTitle')}}</label>
            <input wire:model.lazy="title" type="text" class="form-control" value="{{old('title')}}">
            @error('title') <span class="text-danger error">{{ $message }}</span> @enderror
        </div>
        <div class="mb-3">
            <label class="form-label">* {{__('messages.AnnPrice')}} (&euro;)</label>
        ...
        <div class="mb-3">
            <label class="form-label">* {{__('messages.AnnBody')}}</label>
        ...
        <div class="mb-3">
            <label class="form-label">* {{__('messages.AnnCategory')}}</label>
...
<div class=" mt-2 text-danger">* {{__('messages.AnnObb')}}</div>
